...
public final class Biome extends net.minecraftforge.registries.ForgeRegistryEntry<Biome> {
   ...
   public static final Codec<Biome> CODEC = RecordCodecBuilder.create((builder) -> {
      ...
      }), ResourceLocation.CODEC.fieldOf("forge:registry_name").forGetter(Biome::getRegistryName))
      .apply(builder, (climate, category, depth, scale, effects, gen, spawns, name) ->
          net.minecraftforge.common.ForgeHooks.enhanceBiome(name, climate, category, depth, scale, effects, gen, spawns, builder, Biome::new));
   });
